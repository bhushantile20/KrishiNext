...
const NewSellerDashboard = () => {
  ...
  return (
    <div className="w-full flex flex-row h-[calc(100vh-50px)]">
      <div className="w-2/12 shadow-sm bg-green-50/20 flex justify-between shadow-xl py-4 px-2 flex-col">
        <div className="flex flex-col gap-2">
          {links.map((link, index) => (
            <NavLink
              ...
              to={link.path}
              className={({ isActive }) =>
                `w-full flex flex-row items-center gap-2 py-2 text-base justify-center md:justify-start ${isActive ? 'bg-green-500 text-slate-100 shadow-md' : 'text-gray-700 hover:bg-gray-200'
