    ...
    <>
      ...
      <div className="w-full flex flex-col gap-2 md:flex-row items-center justify-between px-4">
        ...
        <Link to="add" className="w-full md:w-fit text-center">
          <div className="text-md py-2 px-4 text-white rounded cursor-pointer bg-green-500">
                  ...
                  >
                    ...
                    <td className=" px-6 py-4">
                      <span className=" flex justify-center items-center gap-2">
                        <div
                          className="text-md py-2 px-4 text-white rounded cursor-pointer bg-sky-500  whitespace-nowrap"
                          onClick={(e) => {
                            e.preventDefault();
                        ...
                        <div
                          className="text-md py-2 px-4 text-white rounded cursor-pointer bg-red-500 whitespace-nowrap"
                          onClick={() => {
