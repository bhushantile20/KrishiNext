    ...
    <nav className="bg-white border-gray-200 shadow">
      <div className="flex flex-wrap items-center justify-between mx-auto px-4 md:px-12 h-12">
        ...
        <div className="flex flex-row gap-4 md:gap-8 text-2xl md:text-3xl">
          <div
            ref={userDropdownRef}
            className="relative flex flex-row gap-1 justify-center items-center text-blue-600 cursor-pointer"
            onMouseEnter={() => {
          ...
          <div
            ...
            className="relative flex flex-row gap-1 justify-center items-center text-green-600 cursor-pointer"
            onMouseEnter={() => {
